...
import { DOMAIN, IMAGE_MODELS, mainHeaderKeyboardOffset } from '../../constants'
...
export function Images() {
  ...
  const usesFal = imageModel === 'fluxLora'
  const imageEndpoint = usesFal ? 'fal/flux-lora' : 'gemini'
  const showImagePickerButton = !hideInput && !usesFal
  ...
  async function generate() {
    ...
    const providerLabel = usesFal ? 'fal.ai' : 'Gemini'
    try {
      setTimeout(() => {
